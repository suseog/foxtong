...
<head>
	...
	<script type="text/javascript">
		...
		function fn_egov_select_guestList(pageNo) {
			...
			document.board.action = "${pageContext.request.contextPath}/cop/bbs/selectGuestList.fo";
		...
		function fn_egov_deleteGuestList(nttId) {
			jConfirm('<spring:message code="common.delete.msg"/>', '삭제', 'a', function(r) {
				if(r) {
					document.board.nttId.value = nttId;
					document.board.action = "${pageContext.request.contextPath}/cop/bbs/deleteGuestList.fo";
					document.board.submit();
				}
			});
		}
		...
		function fn_egov_insert_guestList() {
			...
			if("insert" == document.registForm.flag.value){
				document.board.action = "${pageContext.request.contextPath}/cop/bbs/insertGuestList.fo";
				document.board.submit();
			}else{
				document.board.action = "${pageContext.request.contextPath}/cop/bbs/updateGuestList.fo";
				document.board.submit();
			}
