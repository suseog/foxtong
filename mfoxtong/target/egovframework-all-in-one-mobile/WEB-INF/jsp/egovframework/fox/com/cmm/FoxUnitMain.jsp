...
<div data-role="content">
    ...
    <div id="top_category">
       <ul>
	      <li><a href="#" class="ui-btn ui-corner-all">필라테스</a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">네일샵 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">에스테틱 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">왁싱 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">성형외과 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">산부인과 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">피부과 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">산후조리원 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">산후조리관리사 </a></li>
	      <li><a href="#" class="ui-btn ui-corner-all">기타 </a></li>
      </ul>
     </div>
	<!-- 카테고리 네비게이션 end  -->
...
<!-- 약관 start-->
	<div align="center">
		<br/>
		<p>
			<a href="${pageContext.request.contextPath}/uss/sam/stp/StplatListInqire.fo"> 이용약관 </a> | 
			<a href="${pageContext.request.contextPath}/uss/sam/stp/StplatListInqire.fo"> 위치기반서비스약관 </a> | 
			<a href="${pageContext.request.contextPath}/uss/sam/stp/StplatListInqire.fo"> 개인정보처리방침 </a>
