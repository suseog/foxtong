...
<div data-role="page" id="list">
	...
	<table width="100%">
		<tr> 
			<td align="left" width="30%"><a href="${pageContext.request.contextPath}/index.jsp" class="ui-btn ui-corner-all ui-icon-arrow-l ui-btn-icon-notext">뒤로</a></td>
			<td align="center" width="35%"><h1 class="bodyLogo" style="font-size:14pt">${brdMstrVO.bbsNm}</h1></td>
			<td align="right" width="35%">
				<a href="${pageContext.request.contextPath}/cop/bbs/searchBoardListView.fo?bbsId=BBSMSTR_000000000002" class="ui-btn ui-corner-all ui-icon-search ui-btn-icon-notext">검색</a>
    ...
    <div data-role="content">
	   ...
	   <!-- 게시글 카테고리  start  -->
	    <div id="top_category">
	       <ul>
		      <li><a href="#" class="ui-btn ui-corner-all">일상생활 </a></li>
		      <li><a href="#" class="ui-btn ui-corner-all">건강  </a></li>
		      <li><a href="#" class="ui-btn ui-corner-all">피부미용  </a></li>
		      <li><a href="#" class="ui-btn ui-corner-all">맛집  </a></li>
		      <li><a href="#" class="ui-btn ui-corner-all">출산/육아 </a></li>
		      <li><a href="#" class="ui-btn ui-corner-all">결혼생활 </a></li>
