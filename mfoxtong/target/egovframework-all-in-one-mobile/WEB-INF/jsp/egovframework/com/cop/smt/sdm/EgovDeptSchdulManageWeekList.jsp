...
<td height="60">
    ...
    <td>
		...
		<td>
			...
			<img src="<c:url value='/images/egovframework/com/cop/smt/sdm/icon/icoPrev.gif'/>" align="middle" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시">
			</a>
			<%=iNowYear%>년
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageWeekList.do'/>?year=<%=iNowYear+1%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek%>">
			<img src="<c:url value='/images/egovframework/com/cop/smt/sdm/icon/icoNxt.gif'/>" align="middle" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시">
			</a>
			</td>
			<td width="80" align="center">
			<%if(iNowMonth > 0 ){ %>
