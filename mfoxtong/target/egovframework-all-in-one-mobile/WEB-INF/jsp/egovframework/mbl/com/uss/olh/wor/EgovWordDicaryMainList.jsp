...
<html>
		...
		<ul data-inset="true">
			<c:choose>
				...
				<c:otherwise>
					...
					<li class="uss-myList">
							<a href="${pageContext.request.contextPath}/uss/olh/wor/WordDicaryDetailInqire.mdo?wordId=${wordDicary.wordId}">
	...
	<div class="uss-btnG">
		<a href="${pageContext.request.contextPath}/uss/olh/wor/WordDicaryListInqire.mdo" data-role="none" data-ajax="false" class="btnGogo">바로가기</a>
	</div>
