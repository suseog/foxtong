<% 
/**
 * @Class Name : EgovOpenApiInquiryHistoryDetail.jsp
...
<html>
	<head>
		...
		<script type="text/javascript">
			function fn_egov_select_openApiList(pageNo) {
				document.listFrm.action = "<c:url value='/mbl/com/oas/selectOpenApiInquiryHistoryList.mdo'/>";
	...
	<body>
		...
		<div id="openApi" class="contents2">
			<table width="100%" cellpadding="8" class="table-search" border="0">
			 	<tr>
			  		<td width="100%"class="title_left">
			   			<img src="<c:url value='/images/egovframework/mbl/mcomd/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;Open-API 조회 이력 - 상세 조회
			   		</td>
			 	</tr>
			</table>
			<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="Open-API 조회 이력에 대한 상세정보를 제공합니다.">
				<tbody>
			  		<tr> 
			    		<th width="20%" height="23" nowrap >Open-API 제공기관&nbsp;</th>
			    		<td width="80%"><c:out value="${openApi.openApiProvdInsttNm}"/></td>
			  		</tr>
			  		<tr> 
					    <th width="20%" height="23" nowrap >Open-API 서비스구분&nbsp;</th>
					    <td width="80%"><c:out value="${openApi.openApiSvcNm}"/></td>
			  		</tr>
			  		<tr> 
			    		<th width="20%" height="138" nowrap >서비스 내용&nbsp;</th>
			    		<td width="80%">
					...
					<tr> 
						<th width="20%" height="23" nowrap >수집일시&nbsp;</th>
					    <td width="80%">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  	...
		  	<div align="center">
				<table border="0" cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td>
					    	<form name="listFrm" method="post" action="<c:url value='/mbl/com/oas/selectOpenApiInquiryHistoryList.mdo'/>">
					      		<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
					      		<input name="searchCondition" type="hidden" value="<c:out value='${searchVO.searchCondition}'/>">
					      		<input name="searchKeyword" type="hidden" value="<c:out value='${searchVO.searchKeyword}'/>">
					      		<span class="button"><input type="submit" value="목록" onclick="fn_egov_select_openApiList('<c:out value='${searchVO.pageIndex}'/>'); return false;"></span>
					      	</form>
						</td>
					</tr>
				</table>
