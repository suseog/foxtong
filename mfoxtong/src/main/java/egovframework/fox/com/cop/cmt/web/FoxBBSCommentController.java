package egovframework.fox.com.cop.cmt.web;
 ...
 */
@Controller
public class FoxBBSCommentController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/selectCommentList.fo")
	...
	if (commentVO.getType().equals("head")) {
		return "egovframework/fox/com/cop/cmt/FoxCommentList";
	}
	////----------------------------------------
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/anonymous/selectCommentList.fo")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/insertComment.fo")
	...
	return "redirect:/cop/bbs/selectBoardArticle.fo?bbsId="+commentVO.getBbsId()+"&nttId="+commentVO.getNttId();
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/anonymous/insertComment.fo")
	...
	return "redirect:/cop/bbs/anonymous/selectBoardArticle.fo?bbsId="+commentVO.getBbsId()+"&nttId="+commentVO.getNttId();
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/deleteComment.fo")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/anonymous/deleteComment.fo")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/selectSingleComment.fo")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/anonymous/selectSingleComment.fo")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/updateComment.fo")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/anonymous/updateComment.fo")
