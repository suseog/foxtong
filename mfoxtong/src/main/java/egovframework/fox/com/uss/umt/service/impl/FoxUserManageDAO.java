 ...
 * </pre>
 */
@Repository("foxUserManageDAO")
public class FoxUserManageDAO extends EgovComAbstractDAO{
...
//        return (Integer)select("foxUserManageDAO.checkIdDplct_S", checkId);
//    }
//
//    /**
...
//        delete("foxUserManageDAO.deleteUser_S", delId);
//    }
//
//
//    /**
...
//        return (String)insert("foxUserManageDAO.insertUser_S", userManageVO);
//    }
//
//    /**
...
//        return (UserManageVO) select("foxUserManageDAO.selectUser_S", uniqId);
//    }
//
//    /**
...
//     */
//    public List<?> selectUserList(FoxUserDefaultVO userSearchVO){
//        return list("foxUserManageDAO.selectUserList_S", userSearchVO);
//    }
//
//    /**
//     * 사용자총 갯수를 조회한다.
...
//     */
//    public int selectUserListTotCnt(FoxUserDefaultVO userSearchVO) {
//        return (Integer)select("foxUserManageDAO.selectUserListTotCnt_S", userSearchVO);
//    }
//
//    /**
...
//        update("foxUserManageDAO.updateUser_S",userManageVO);
//    }
//
//    /**
...
//    	return (String)insert("foxUserManageDAO.insertUserHistory_S", userManageVO);
//    }
//
//    /**
//     * 업무사용자 암호수정
...
//        update("foxUserManageDAO.updatePassword_S", passVO);
//    }
//
//    /**
...
//    	return (UserManageVO) select("foxUserManageDAO.selectPassword_S", userManageVO);
//    }
