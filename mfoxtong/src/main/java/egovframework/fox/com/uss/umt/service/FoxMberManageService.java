 ...
 * </pre>
 */
public interface FoxMberManageService {
	 ...
	 * @throws Exception
	 */
	public String insertMber(FoxMberManageVO mberManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public FoxMberManageVO selectMber(String mberEmailAdres) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<FoxMberManageVO> selectMberList(FoxUserDefaultVO userSearchVO) throws Exception;
     ...
     * @throws Exception
     */
    public int selectMberListTotCnt(FoxUserDefaultVO userSearchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void updateMber(FoxMberManageVO mberManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void updatePassword(FoxMberManageVO mberManageVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public FoxMberManageVO selectPassword(FoxMberManageVO passVO) throws Exception;
