 ...
 *   수정일      수정자           수정내용
 *  -------    --------    ---------------------------
 *   2011.08.18  정홍규          최초 생성
 *
 * </pre>
 */

public class DeviceIdentVO extends DeviceIdent implements Serializable {

	private static final long serialVersionUID = 4151880130157703815L;
