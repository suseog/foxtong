...
public class EgovClubManageController {
	...
	public String insertClubInf(@ModelAttribute("searchVO") ClubVO clubVO, @ModelAttribute("club") Club club, BindingResult bindingResult, SessionStatus status, ModelMap model)
			throws Exception {
	...
	public String forUpdateClbInf(@ModelAttribute("searchVO") ClubVO clubVO, ModelMap model) throws Exception {
		...
		model.addAttribute("clubVO", map.get("clubVO"));
		model.addAttribute("clubUser", map.get("clubUser"));
		model.addAttribute("result", map.get("resultList"));
	...
	public String updateClbInf(@ModelAttribute("searchVO") ClubVO clubVO, @ModelAttribute("club") Club club, BindingResult bindingResult, SessionStatus status, ModelMap model)
			throws Exception {
