...
public class EgovIndvdlSchdulManageController {
	...
	public String egovIndvdlSchdulManageMainList(@RequestParam Map<?, ?> commandMap, ModelMap model)
    throws Exception {
	...
	public String egovIndvdlSchdulManageWeekList(
			@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<Object, Object> commandMap,
			IndvdlSchdulManageVO indvdlSchdulManageVO,
    		ModelMap model)
    throws Exception {
	...
	public String egovIndvdlSchdulManageDetail(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			IndvdlSchdulManageVO indvdlSchdulManageVO, @RequestParam Map<?, ?> commandMap,
