...
public class BoardVO extends Board implements Serializable {
	...
	/**
	 * @return the nttThemaSeCode
	 */
	public String getNttThemaSeCode() {
		return nttThemaSeCode;
	}

	/**
	 * @param nttThemaSeCode the nttThemaSeCode to set
	 */
	public void setNttThemaSeCode(String nttThemaSeCode) {
		this.nttThemaSeCode = nttThemaSeCode;
	}
