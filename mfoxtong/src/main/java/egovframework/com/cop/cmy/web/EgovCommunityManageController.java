...
public class EgovCommunityManageController {
	...
	public String insertCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO, @ModelAttribute("community") Community community, BindingResult bindingResult,
	...
	public String forUpdateCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
	...
	public String updtCmmntyInf(@ModelAttribute("searchVO") CommunityVO cmmntyVO, @ModelAttribute("community") Community community, BindingResult bindingResult,
			SessionStatus status, ModelMap model) throws Exception {
