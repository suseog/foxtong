...
public class EgovWordDicaryController {
    ...
    /**불필요한 코드 주석처리
    @RequestMapping(value="/uss/olh/wor/EgovMenuManageMain.do")
    public String EgovMenuManageMain(ModelMap model) throws Exception {
    	return "egovframework/com/uss/olh/wor/EgovMenuManageMain";
    }

    @RequestMapping(value="/uss/olh/wor/EgovMenuManageLeft.do")
    public String EgovMenuManageLeft(ModelMap model) throws Exception {
    	return "egovframework/com/uss/olh/wor/EgovMenuManageLeft";
    }
    **/
    ...
    public String	selectWordDicaryDetail(WordDicaryVO wordDicaryVO,
    ...
    public String addWordDicaryView(
            @ModelAttribute("searchVO") WordDicaryDefaultVO searchVO, Model model)
            throws Exception {
    ...
    public String insertWordDicary(
            @ModelAttribute("searchVO") WordDicaryDefaultVO searchVO,
    		@ModelAttribute("wordDicaryVO") WordDicaryVO wordDicaryVO,
    ...
    public String wordDicaryUpdtView(@RequestParam("wordId") String wordId ,
            @ModelAttribute("searchVO") WordDicaryDefaultVO searchVO,
            ModelMap model)
            throws Exception {
