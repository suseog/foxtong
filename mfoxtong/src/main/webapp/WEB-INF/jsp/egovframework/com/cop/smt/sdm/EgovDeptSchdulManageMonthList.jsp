...
<td height="60">
    ...
    <td>
		...
		<td>
			...
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do'/>?year=<%=year-1%>&amp;month=<%=month%>"><img src="<c:url value='/images/egovframework/com/cop/smt/sdm/icon/icoPrev.gif'/>" align="middle" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시"></a>
			<%=year%>년
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do'/>?year=<%=year+1%>&amp;month=<%=month%>"><img src="<c:url value='/images/egovframework/com/cop/smt/sdm/icon/icoNxt.gif'/>" align="middle" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시"></a>
			</td>
			<td width="80" align="center">
			<%if(month > 0 ){ %>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do'/>?year=<%=year%>&amp;month=<%=month-1%>"><img src="<c:url value='/images/egovframework/com/cop/smt/sdm/icon/icoPrev.gif'/>" align="middle" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시"></a>
			<%}%>
			<%=month+1%>월
			<%if(month < 11 ){ %>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.do'/>?year=<%=year%>&amp;month=<%=month+1%>"><img src="<c:url value='/images/egovframework/com/cop/smt/sdm/icon/icoNxt.gif'/>" align="middle" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시"></a>
			<%}%>
			</td>
			</tr>
			</table>
