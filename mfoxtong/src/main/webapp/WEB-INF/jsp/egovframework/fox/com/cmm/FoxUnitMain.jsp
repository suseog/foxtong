    ...
    <div class="business_list">
        <ul>
			...
			<c:otherwise>
	            ...
	            <li>
	                	<a href="javascript:retrieveBsshInfoDetail('<c:out value="${bsshInfo.bsshEsntlId}"/>');" rel="external">
	                <figure>
                    	<img src="${pageContext.request.contextPath}/images/egovframework/fox/com/cmm/business_logo.png" alt="">
                    	  <!-- 
					  	  <c:if test="${bsshInfo.bsshPhotoId != ''}">
					  	    <img class="img-round" src="<c:url value='${pageContext.request.contextPath}/cmm/fms/getImage.do'/>?atchFileId=<c:out value='${bsshInfo.bsshPhotoId}'/>&fileSn=0" class="mcomd-photo"/>
						  </c:if>
						  -->  
	                </figure>
			    		</a>
