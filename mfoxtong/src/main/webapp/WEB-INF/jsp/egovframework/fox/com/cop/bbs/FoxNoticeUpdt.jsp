		...
		<script type="text/javascript">
			...
			function fn_egov_regist_notice(){
				...
				if (!validateBoard(document.board)){
					...
					document.board.action = "${pageContext.request.contextPath}/cop/bbs${prefix}/updateBoardArticle.fo";
			...
			function fn_egov_inqire_notice(nttId, bbsId) {
				...
				document.board.action =  "${pageContext.request.contextPath}/cop/bbs${prefix}/selectBoardArticle.fo";
				document.board.submit();			
			}	
