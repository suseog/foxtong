...
function retrieveBsshInfoDetail(str){
	$('#bsshEsntlId').val(str);
	document.foxBsshInfoDefaultVO.action="${pageContext.request.contextPath}/fox/bsh/retrieveBsshInfo.fo";
	document.foxBsshInfoDefaultVO.submit();	
}
    ...
    <div class="business_list">
        <ul>
			...
			<c:otherwise>
	            ...
	            <li>
	                	<a href="javascript:retrieveBsshInfoDetail('<c:out value="${result.bsshEsntlId}"/>');" rel="external">
	                <figure>
