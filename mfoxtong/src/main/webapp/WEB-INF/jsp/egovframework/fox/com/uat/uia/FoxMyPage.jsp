...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/egovframework/fox/com/cmm/FoxMyPage.css"/>
...
<!-- 메인 페이지 -->
	<div class="container">
        ...
        <div class="main_content">
            <div class="top_area">
                <div class="title">
                    <h2><c:out value='${sessionScope.loginVO.ncnm}'/><span>님</span></h2>
                    <div class="chk_btn">
                        <a href="javascript:myFoxInfoModify();" rel="external"><span>정보수정</span></a>
                    </div>
                </div>
            ...
            <div class="bottom_area">
                <ul>
                    <li>
                        <strong>공지사항</strong>
                        <figure>
                            <img src="${pageContext.request.contextPath}/images/egovframework/fox/com/cmm/right_arrow.png" alt="">
                        </figure>
                    </li>
                    <li>
                    ...
                    <li>
	                 ...
	                 <c:choose> 
				      	<c:when test="${empty sessionScope.foxBsshInfoManageVO}">
							<!-- 일반회원인경우 -->
							<a href="${pageContext.request.contextPath}/fox/bsh/entrpsEmplyrSbscrbRequstView.fo" rel="external">
							<li>
		                        <strong>업체사용자가입요청 <c:out value="${sessionScope.foxBsshInfoManageVO.mtltyNm}"/> </strong>
		                        <figure>
		                            <img src="${pageContext.request.contextPath}/images/egovframework/fox/com/cmm/right_arrow.png" alt="">
		                        </figure>
		                    </li>
						...
						<c:otherwise>
					 		<!-- 업체관리자인경우-->
							<a href="javascript:modifyBsnBassInfoView('<c:out value="${sessionScope.foxBsshInfoManageVO.bsshEsntlId}"/>')" rel="external">
							<li>
		                        <strong>영업점관리 <c:out value="${sessionScope.foxBsshInfoManageVO.mtltyNm}"/> </strong>
		                        <figure>
		                            <img src="${pageContext.request.contextPath}/images/egovframework/fox/com/cmm/right_arrow.png" alt="">
		                        </figure>
		                    </li>
