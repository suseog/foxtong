...
<div data-role="page" id="Add_Page">
	...
	<div data-role="header">
		<a href="javascript:fn_showList();" class="ui-btn ui-corner-all ui-icon-arrow-l ui-btn-icon-notext">뒤로</a>
...
<form:form commandName="board" name="board" method="post" enctype="multipart/form-data">
	...
	<div data-role="content" class="com-ussContent">
		...
		<!--  제목은 입력하지 않는 것으로 하고 주석 처리 : 2021.12.23 jss
		 ...
		 -->	
		<!-- 게시글 카테고리  start  --> 맥에서는 왜 그런걸까 
	    <div id="top_category">
		<fieldset class="ui-field-contain">
		<!--
	        <label for="nttThemaSeCode">주제선택</label>
	        -->
		...
		<!-- 게시글 카테고리 end  -->
			...
			<div class="uss-regist" data-inline="true">
	        	...
	        	<textarea cols="40" rows="40" name="nttCn" id="nttCn" data-clear-btn="true" placeholder="글내용을 입력해주세요." class="com-textContents"></textarea>
			</div>
			<c:choose>
		...
		<div class="ui-grid-a addBgBtn">
			<div class="ui-block-a">
                <input type="button" value="글올리기 " onclick="fn_egov_regist_notice()" data-icon="plus" data-ajax="false" >
			</div>
			<div class="ui-block-b">
                <input type="reset" value="재작성"  data-icon="refresh"/>
			</div>
		</div>
