...
.main_content .photo_profile {
    margin-bottom: 15px;
    position: relative;
}

.main_content .photo_profile label {
    display: block;
    margin-bottom: 10px;
    color: #999;
    font-size: 14px;
...
<!-- content start -->
	<div class="main_content">
		...
		<div class="photo_profile">
			...
			<table width="100%" align="center">
			    ...
			    <tr> 
		            <td width="320px" height="200px" align="center">
		                <img width="320px" height="200px" src="<c:url value='${pageContext.request.contextPath}/cmm/fms/getImage.do'/>?atchFileId=<c:out value='${result.bsshPhotoId}'/>&fileSn=0" class="mcomd-photo"/>
		            </td>
			    </tr>
			  </c:if>  
		  	</table>
	  	...
	  	<div class="img_wrap">
               <ul>
                   <li>
                       <figure>
                           <label for="btnAtt">
                               <img src="${pageContext.request.contextPath}/images/egovframework/fox/com/cmm/camera.png" alt="">
                           </label>
                       </figure>
                   ...
                   <input type=file id="egovComFileUploader" title="업소메인프로필사진"  name="file_1" accept="image/*">
               </ul>
       	</div>
		...
		<div>
	        <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
			    <tr>
			        <td><input name="file_1" id="egovComFileUploader" type="file" title="업소메인프로필사진" accept="image/*" class="file_btn"/></td>
			    </tr>
	       </table>
		</div>
		-->
		...
		<!--업소 캠페인 문구  -->
		<div class="input_box">
          <label for="">캠페인문구(한줄)</label>
          <input type="text" name="bsshCmpgnWords" id="bsshCmpgnWords" value="<c:out value='${result.bsshCmpgnWords}'/>" />
	    </div>
	
		<!-- 업소정보소개(text) -->
		<div class="textarea">
	         <label for="">업소소개내용</label>
	         <textarea name="bsshIntrcnCn" id="bsshIntrcnCn" ><c:out value='${result.bsshIntrcnCn}'/></textarea>
	    </div>
        <br/>        
	<!-- 영업시간 -->	
	<div class="select_box">
		...
		<table width="100%">
			<tr>
				<td width="50%">
				<span>시작:</span>
				<select name="bsnBeginTime" id="bsnBeginTime" class="select">
				...
				<td width="50%">
				<span>종료:</span>
				<select name="bsnEndTime" id="bsnEndTime" class="select">
		 			<option value="17">17</option>
		 			<option value="18">18</option>
	...
	<!-- 
	<div>
	<span><c:out value='${result.bsnBeginTime}'/></span>
	<span><c:out value='${result.bsnEndTime}'/></span>
	</div>
	 -->
    <div class="btn_wrap">
           <button type="button" onclick="javascript:modifyBsnBsshInfo();">프로필 수정 완료</button>
    </div>
	</form>
	<br/>
	<br/>
...
<!-- content end -->
<script>
$("#bsnBeginTime").val("<c:out value='${result.bsnBeginTime}'/>").prop("selected", true);
$("#bsnEndTime").val("<c:out value='${result.bsnEndTime}'/>").prop("selected", true);
</script>
<!-- footer start -->
